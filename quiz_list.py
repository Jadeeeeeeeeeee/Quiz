...
english = ["hello", "welcome", "goodmorning", "egg", "dog", "cat" ]
right_answer = ["Kia ora", "Nau mai, haere mai mean", "mōrena", "hēki", "pero","ngeru"]
option_1 = ["pero" , "aroha" , "pero", "ngeru", "koe",""]
option_2 = ["Nau mai, haere hai" , "mōrena" , "hēki", "Nau mai", "ngeru"]
